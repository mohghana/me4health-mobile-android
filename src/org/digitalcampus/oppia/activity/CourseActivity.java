...
@SuppressLint("NewApi")
public class CourseActivity extends FragmentActivity implements ActionBar.TabListener, OnInitListener,OnSharedPreferenceChangeListener{
    ...
    private void loadActivities(){
        ...
        for (int i = 0; i < activities.size(); i++) {
            ...
            if (activity.getActType().equalsIgnoreCase("page")){
                fragments.add( PageWidget.newInstance(activity, course, isBaseline,CourseActivity.this) );
