	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        listView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
                ...
                Intent i = new Intent(DownloadActivity.this, OppiaMobileActivity.class);
	...
	public void refreshCourseList() {
		...
		try {
			...
			for (int i = 0; i < (json.getJSONArray(MobileLearning.SERVER_COURSES_NAME).length()); i++) {
                ...
                course.setCourseTag(json_obj.getString("course_tag"));
    ...
    public void onInstallComplete(String fileUrl) {
        ...
        if (course != null){
            ...
            // Add the buttons
               ...
               .setTitle("Course Download");
            builder.setPositiveButton(R.string.ok, new DialogInterface.OnClickListener() {
                       public void onClick(DialogInterface dialog, int id) {
                          startActivity(new Intent(DownloadActivity.this, OppiaMobileGroupActivity.class));
                       }
                   });
        ...
        public void onClick(int position) {
            ...
            if (!courseSelected.isDownloading()){
                if(!courseSelected.isInstalled() || courseSelected.isToUpdate()){
                    ...
                    mServiceIntent.putExtra(CourseIntallerService.SERVICE_COURSETAG, courseSelected.getCourseTag());
