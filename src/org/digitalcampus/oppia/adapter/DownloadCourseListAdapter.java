...
public class DownloadCourseListAdapter extends ArrayAdapter<CourseIntallViewAdapter>{
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        final DownloadCourseViewHolder viewHolder;
	  ...
	  /*  if (desc != null){
	    	...
	    	CourseSizeTask task=new CourseSizeTask(ctx,courseList.get(position).getDownloadUrl(),viewHolder.courseDescription);
	    	task.execute();
	    	// viewHolder.courseDescription.setText(task);
