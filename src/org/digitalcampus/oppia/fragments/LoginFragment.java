...
public class LoginFragment extends Fragment implements SubmitListener {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		...
		db=new DbHelper(super.getActivity());
	...
	public void submitComplete(Payload response) {
		...
		if(response.isResult()){
			...
			// return to main activity
	    	 userInfo=db.getUserDetails(usernameField.getText().toString());
	    	 System.out.println(userInfo.get(0).getSurveyStatus());
	    	if(userInfo.get(0).getSurveyStatus().equals("taken")){
