...
public class CourseIntallerService extends IntentService {
    ...
    public static final String SERVICE_COURSETAG = "course_tag";
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        if (intent.getStringExtra(SERVICE_ACTION).equals(ACTION_DOWNLOAD)){
            ...
            String courseTag = intent.getStringExtra(SERVICE_COURSETAG);
            ...
            if (success){ installDownloadedCourse(fileUrl, shortname, versionID,courseTag); }
        }
    ...
    private void installDownloadedCourse(String fileUrl, String shortname, Double versionID,String courseTag) {
