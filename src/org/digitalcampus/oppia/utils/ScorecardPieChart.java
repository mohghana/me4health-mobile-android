...
public class ScorecardPieChart {
	...
	public void drawChart(int margin, boolean showSegementTitles, boolean delayedStart){
        ...
        if (numCompleted != 0){
            segmentCompleted.setTitle( showSegementTitles ? "     (" + numCompleted + ")" : "");
        ...
        if (numStarted != 0){
            segmentStarted.setTitle( showSegementTitles ? "     (" + numStarted + ")" : "");
        ...
        segmentNotStarted.setTitle( (showSegementTitles && numNotStarted != 0)? "     (" + numNotStarted + ")" : "");
